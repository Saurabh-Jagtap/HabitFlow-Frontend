  ...
  return (
    <main className="min-h-screen bg-base-200 px-4 py-10">
      <div className="mx-auto w-full max-w-2xl">
        {/* Back Links */}
        <Link href="/settings" className="inline-flex items-center gap-2 text-sm text-base-content/60 hover:text-base-content transition mb-6">
          <ArrowLeft size={16} />
          Back to Settings
        </Link>
          ...
          <section className="rounded-xl p-6 border border-rose-500/30 bg-rose-500/5">
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full rounded-lg px-4 py-2 bg-base-300/60 focus:outline-none
